...
# Palette + global CSS live in app/theme.py (shared with the static-site
# build). Aliased to the historical private names used below.
from app.theme import (  # noqa: E402
    PALETTES as _PALETTES, THEME_CSS as _THEME_CSS, theme_css as _theme_css)
