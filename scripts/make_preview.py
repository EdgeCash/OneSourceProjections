...
from project547 import playerlogs, teamstats  # noqa: E402
...
<title>Project 54.7 — preview</title></head>
...
<div style='display:flex;min-height:100vh;'>
  <div style='width:190px;background:#0b0f16;border-right:1px solid #1c2330;padding:16px 12px;'>
    <div style='font-size:1.25rem;font-weight:800;margin-bottom:14px;'>🎯 Project 54.7</div>
    {nav}
  </div>
